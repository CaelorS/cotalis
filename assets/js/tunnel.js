...
(function () {
  ...
  function showStep() {
    ...
    $('panel').classList.add('hidden');   // le chiffrage n'est montré qu'après les coordonnées, dans le rapport
    document.body.classList.toggle('locked', !viewer && !S.leadSubmitted);   // masque aussi les sous-totaux par lot
